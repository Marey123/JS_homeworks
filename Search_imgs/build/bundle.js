...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"photo-card\">\r\n  <img src="
    + alias4(((helper = (helper = lookupProperty(helpers,"webformatURL") || (depth0 != null ? lookupProperty(depth0,"webformatURL") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"webformatURL","hash":{},"data":data,"loc":{"start":{"line":4,"column":11},"end":{"line":4,"column":27}}}) : helper)))
    + " alt="
    + alias4(((helper = (helper = lookupProperty(helpers,"tags") || (depth0 != null ? lookupProperty(depth0,"tags") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"tags","hash":{},"data":data,"loc":{"start":{"line":4,"column":32},"end":{"line":4,"column":40}}}) : helper)))
    + "\" class =\"ImageBig\" />\r\n  <div class=\"stats\">\r\n    <p class=\"stats-item\">\r\n      <i class=\"material-icons\">thumb_up</i>\r\n       "
    + alias4(((helper = (helper = lookupProperty(helpers,"likes") || (depth0 != null ? lookupProperty(depth0,"likes") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"likes","hash":{},"data":data,"loc":{"start":{"line":8,"column":7},"end":{"line":8,"column":16}}}) : helper)))
    ...
    + alias4(((helper = (helper = lookupProperty(helpers,"comments") || (depth0 != null ? lookupProperty(depth0,"comments") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"comments","hash":{},"data":data,"loc":{"start":{"line":16,"column":5},"end":{"line":16,"column":17}}}) : helper)))
  ...
  return "\r\n"
    + ((stack1 = lookupProperty(helpers,"each").call(depth0 != null ? depth0 : (container.nullContext || {}),depth0,{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":2,"column":0},"end":{"line":24,"column":9}}})) != null ? stack1 : "");
},"useData":true});
...
// EXTERNAL MODULE: ./node_modules/mini-css-extract-plugin/dist/loader.js??ruleSet[1].rules[1].use[1]!./node_modules/css-loader/dist/cjs.js!./src/CSS/style.css
var style = __webpack_require__(945);
...
/* harmony default export */ const CSS_style = ((style_default()).locals || {});
// EXTERNAL MODULE: ./node_modules/lodash/lodash.js
var lodash = __webpack_require__(486);
// EXTERNAL MODULE: ./src/template/Images.hbs
var Images = __webpack_require__(618);
var Images_default = /*#__PURE__*/__webpack_require__.n(Images);
...
var Gallery = /*#__PURE__*/function () {
  function Gallery() {
    ...
    this.quest = " ";
    this.counter = 1;
    this.myquest = "&q=".concat(this.quest);
    this.mycounter = "&page=".concat(this.counter);
    this.My_API = "22079208-c9aa458b33ba9021c4ae816c4";
    this.URN = "https://pixabay.com/api/?image_type=photo&orientation=horizontal&per_page=12&key=".concat(this.My_API);
  }

  _createClass(Gallery, [{
    key: "InputTag",
    value: function InputTag() {
      var _this = this;

      refs.input.addEventListener("input", lodash.debounce(function (event) {
        if (event.target.value === " ") {
          refs.input.innerHTML = " ";
        }

        _this.quest = event.target.value;
    ...
    value: function FetchUrl() {
      ...
      fetch(url).then(function (res) {
        ...
        var markup = Images_default()(data.hits);
        refs.gallery.innerHTML = markup;
      });
    }
  }, {
    key: "TabButton",
    value: function TabButton() {
      var _this2 = this;

      refs.button.addEventListener("click", function () {
        _this2.counter++;
        _this2.myquest = "&q=".concat(_this2.quest);
        _this2.mycounter = "&page=".concat(_this2.counter);
        url = _this2.URN + _this2.myquest + _this2.mycounter;
        fetch(url).then(function (res) {
          return res.json();
        }).then(function (data) {
          var markup = Images_default()(data.hits);
